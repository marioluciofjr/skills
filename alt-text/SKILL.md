---
name: alt-text
description: Gera um alt text para ser utilizado em blogposts ou posts de LinkedIn
---
...
3 - Jamais coloque mensagem iniciais ou finais. Foque apenas em executar a tarefa, respeitando o que foi estipulado no formato.